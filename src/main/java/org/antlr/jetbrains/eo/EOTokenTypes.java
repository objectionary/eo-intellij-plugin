...
public class EOTokenTypes {
    ...
    public static RuleIElementType getRuleElementType(@MagicConstant(valuesFromClass = EOParser.class)int ruleIndex){
        return RULE_ELEMENT_TYPES.get(ruleIndex);
    }
    public static TokenIElementType getTokenElementType(@MagicConstant(valuesFromClass = EOLexer.class)int ruleIndex){
